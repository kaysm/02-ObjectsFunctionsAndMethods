...
def main():
    ...
    # better_draw_circles(rg.Point(0, -200), 25)
    # better_draw_circles(rg.Point(50, 100), 6)
    # even_better_draw_circles(rg.Point(50, 100), 4, 30, 'red', 3)
    # even_better_draw_circles(rg.Point(50, 100), 12, 5, 'blue', 9)

    even_better_draw_circles(rg.Point(0, 0), 2, 100, 'purple', 2)
...
def even_better_draw_circles(point, r, j, color, thic):
    ...
    turtle = rg.SimpleTurtle()
    turtle.pen = rg.Pen(color, thic)
    turtle.pen_up()
    turtle.go_to(point)
    turtle.set_heading(0)  # Point "east" (towards the right)

    for k in range(1, j+1):  # k becomes 1, 2, 3, ... 10
